...
const Controls = (props: PropType) => {
    ...
    return(
        <div className="bg-code-page-secondary flex h-12 justify-evenly items-center">
            <button 
                className={`bg-white p-2 rounded-full text-black hover:text-white ${trackState.audio ? 'hover:bg-red-500' : 'hover:bg-green-500'}`}
                onClick={() => mute("audio")}
            >
                {trackState.audio 
                    ? 
